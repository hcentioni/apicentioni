...
exports.getTicketDetalleCtrl = exports.addDetalleCtrl = void 0;
var _ticket_detalle = require("../services/ticket_detalle.service");
...
var getTicketDetalleCtrl = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var IdTicket, responseDetalle;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          IdTicket = req.params.id;
          _context.next = 3;
          return (0, _ticket_detalle.getTicketDetalle)(IdTicket);
        case 3:
          responseDetalle = _context.sent;
  ...
  return function getTicketDetalleCtrl(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

//AGREGAR UNO DETALLE
exports.getTicketDetalleCtrl = getTicketDetalleCtrl;
var addDetalleCtrl = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var _req$body, IdTicket, Mensaje, ComentarioInterno, Adjunto, IdUsuario, AdjuntoNameOrg, IdContacto, ticket, responseDetalle;
  ...
  return function addDetalleCtrl(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

//NOTIFICACIONES POR MAILS
exports.addDetalleCtrl = addDetalleCtrl;
var notificarMensajeRespondido = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(ticket) {
    var parametros, responseTicket, plantilla, email, createTransport;
          ...
          try {
            if ((0, _validar.isValidEmail)(responseTicket[0].emailContacto)) {
              email = {
                ...
                //destinatario
                subject: "Ticket Respondido",
                //asunto del correo
                html: plantilla
              };
              createTransport = nodemailer.createTransport(_mails.jConfig);
  ...
  return function notificarMensajeRespondido(_x5) {
